      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-3">
          ...
          if(isset($_GET['search'])) 
		  {
			...
			$get_products = "select * from products where products_keywords like '$user_keyword'";
			
			$run_products= mysqli_query($dbcon, $get_products);
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <a href="#"><img src="img/heart-1403474_1280.jpg" width="200" height="100">
        <div class="carousel-caption"><h2>Welcome to Storebuck</h2></div></a>
      </div>

      <div class="item">
       <a href="#"><img src="img/post5-big.jpg" width="200" height="100" ><div class="carousel-caption"><h2>Coming Soon</h2></div></a>
      </div>
    
      <div class="item">
       <a href="#"><img src="img/post1-big.jpg" width="200" height="100"><div class="carousel-caption"><h2>Coming Soon</h2></div></a>
      </div>

      <div class="item">
        <a href="#"><img src="img/post6-big.jpg" width="200" height="100"><div class="carousel-caption"><h2>Coming Soon</h2></div></a>
      </div>
    </div>
