...
<link rel="stylesheet" href="css/style12.css" /><link rel="stylesheet" href="css/search.css" />
</head>
      ...
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><span style="color:#099">STORE<span style="color:#FFFFFF">BUCK.in</a>
            ...
            <p class="center">Please enter the following information to create your account.</p>
        ...
        <div class="form-group">
          ...
          <input type="Password" name="Password_1" placeholder="Password" class="form-control" required="required">
        </div>
        
        <div class="form-group">
          
          <input type="Password" name="Password_2" placeholder="Confirm Password" class="form-control" required="required">
        </div>
        
        <div class="form-group">					
					</div>
					<div class="panel-footer">
						<button type="submit" name="go" class="btn btn-lg btn-block btn-primary">Start Shopping</button>
					</div>
				</form>
			</div>
...
$insert_customer ="insert into signup (Mobile,Name,Email,Password_1,Password_2) values ('$Mobile','$Name','$Email','$Password_1','$Password_2')";
