    ...
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
    		<form role="form" class="sign_up_form">
    			<center><h2 class="sign_up_title">Reset password</h2></center>
    			<center><p>Enter your email address we will sent you the password reset link.</p></center>
    			<div class="form-group">
    				<input type="email" name="email" id="email" class="form-control input-lg" placeholder="Email" tabindex="4">
    			</div>
    			<div class="row">
    				<div class="col-xs-12 col-md-12"><a href="#" class="btn btn-success btn-block btn-lg">Reset</a></div>
    			</div>
    		</form>
    	</div>
    </div>
