		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-square-o"></i>View Orders</li>
					</ol>
				</div>
			</div>
              <!-- page start-->
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="available_quantity">PRODUCT RATE</label>  
  <div class="col-md-4">
  <input id="product_rate" name="product_rate" placeholder="PRODUCT RATE" class="form-control input-md" required type="text">
