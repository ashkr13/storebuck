...
<div class="form-group">
  <label class="col-md-4 control-label" for="product_name">PRODUCT KEYWORD</label>  
  <div class="col-md-4">
  <input id="product_keyword" name="product_keyword" placeholder="PRODUCT KEYWORD" class="form-control input-md" required type="text">
...
mysqli_query($con,"insert into product values('','$_POST[product_name]','$_POST[product_categorie]',$_POST[product_quantity],$_POST[product_price],'$_POST[product_description]','$_POST[percentage_discount]','$dst1','$_POST[percentage_keyword]')");
