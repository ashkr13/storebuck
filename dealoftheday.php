...
<nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="http://www.storebuck.in/"><span style="color:#0066FF">STORE<span style="color:#FFFFFF">BUCK.in</a>
        </div>
    ...
    <div class="row">
      ...
      <h6>Keep in Touch</h6>
        <div class="social-icons">
                ...
                <a href="https://www.facebook.com/Storebuck/"><i class="fa fa-facebook-square fa-3x social-fb" id="social"></i></a>
	            ...
	            <a href=""><i class="fa fa-linkedin-square fa-3x social-in" id="social"></i></a>
